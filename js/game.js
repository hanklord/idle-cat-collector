(function(){
  ...
  function Game(){
    ...
    this.save=new CC.Save(this); this.coins=this.save.data.coins; this.owned=this.save.data.owned; this.levels=this.save.data.levels;
  ...
  Game.prototype.rate=function(){return this.scene?this.scene.cats.reduce(function(n,c){return n+(c.active?c.def.baseOutput*self.upgrade.mult(c.def):0)},0):0};
